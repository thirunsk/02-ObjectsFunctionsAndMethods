...
def try_methods_and_functions():
    ...
    garrett.pen=rg.Pen('blue',5)
    garrett.backward(150)
    garrett.speed=1
    draw_many_squares(garrett,2,100,30)
    garrett.speed=5
    garrett.pen=rg.Pen('red',5)
    draw_many_squares(garrett,10,50,15)
    garrett.speed=100
    garrett.pen=rg.Pen('red',35)
    draw_many_squares(garrett,8,300,60)
    garrett.pen = rg.Pen('black',3)
    garrett.backward(200)
    garrett.draw_circle(30)
    garrett.draw_square(50)
