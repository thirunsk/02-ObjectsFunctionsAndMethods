...
def main():
    ...
    # -------------------------------------------------------------------------
    #better_draw_circles(rg.Point(100,50)) #draws circles at point (100,50)
    better_draw_circles(rg.Point(-200, 10), 10) #draws circles at point (-200,0)
    even_better_draw_circles(rg.Point(50, 50),12,30,'navy blue',43)
...
def even_better_draw_circles(point,radiiincrease,numbercircles,pencolor,penthickness):
    turtle = rg.SimpleTurtle()
    ...
    for k in range(1, numbercircles):  # k becomes 1, 2, 3, ... 10
